...
void spmm(const choreo::spanned_view<choreo::f16, 2> & lhs_packed, const choreo::spanned_view<choreo::u32, 2> & lhs_meta, const choreo::spanned_view<choreo::f16, 2> & rhs, const choreo::spanned_view<choreo::f16, 2> & output) {
  ...
  uint64_t __choreo_tma_0_shape[] = {SPMM_DEFAULT_K / 2, SPMM_DEFAULT_M};
  uint64_t __choreo_tma_0_strides[] = {SPMM_DEFAULT_K};
  ...
  uint64_t __choreo_tma_1_shape[] = {SPMM_DEFAULT_K, SPMM_DEFAULT_N};
  uint64_t __choreo_tma_1_strides[] = {SPMM_DEFAULT_K * sizeof(choreo::f16)};
  ...
  uint64_t __choreo_tma_2_shape[] = {SPMM_DEFAULT_K, SPMM_DEFAULT_N};
  uint64_t __choreo_tma_2_strides[] = {SPMM_DEFAULT_K * sizeof(choreo::f16)};
  ...
  uint64_t __choreo_tma_3_shape[] = {SPMM_DEFAULT_N, SPMM_DEFAULT_M};
  uint64_t __choreo_tma_3_strides[] = {SPMM_DEFAULT_N * sizeof(choreo::f16)};
  ...
  uint64_t __choreo_tma_4_shape[] = {SPMM_DEFAULT_K / 32, SPMM_DEFAULT_M};
  uint64_t __choreo_tma_4_strides[] = {(SPMM_DEFAULT_K / 32) * sizeof(u32)};
  ...
  choreo::runtime_check((SPMM_DEFAULT_M % SPMM_TILE_M) == 0,
                        "SPMM_DEFAULT_M must be divisible by SPMM_TILE_M");
  choreo::runtime_check((SPMM_DEFAULT_N % SPMM_WARP_N) == 0,
                        "SPMM_DEFAULT_N must be divisible by SPMM_WARP_N");
  dim3 __spmm_gdims0(SPMM_DEFAULT_M / SPMM_TILE_M, SPMM_DEFAULT_N / SPMM_WARP_N, 1);
