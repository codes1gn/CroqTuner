...
describe("TaskList", () => {
  ...
  it("renders multiple tasks", () => {
    const tasks: TaskData[] = [
      mockTask,
      { ...mockTask, id: 2, shape_key: "e4m3_512x8192x8192_fs", status: "pending", current_iteration: 0, best_tflops: null },
    ];
    render(
      <MemoryRouter>
    ...
    expect(screen.getByText("f16_768x768x768")).toBeInTheDocument();
    expect(screen.getByText("e4m3_512x8192x8192_fs")).toBeInTheDocument();
  });
});
